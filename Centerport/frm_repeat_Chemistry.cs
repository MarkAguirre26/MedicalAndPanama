...
namespace MedicalManagementSoftware
{
    public partial class frm_repeat_Chemistry : Form
    {
        ...
        void Save()
        {
            ...
            if (cb_hba1c.Checked == true) { hba1c_H = "1"; } else { hba1c_H = "0"; }
        ...
        void loadPreviousExam()
        {
            ...
            if (i != null)
            {
                ...
                if (hba1c_H == "1") { cb_hba1c.Checked = true; } else { cb_hba1c.Checked = false; }
        ...
        private void cmd_more_Click(object sender, EventArgs e)
        {
            using (frm_ChemOthers f = new frm_ChemOthers())
            {
                ...
                //if (hba1c_H == "1") { f.hb.Checked = true; } else { f.checkBox2.Checked = false; }  pending
        ...
        private void cb_trigly_CheckedChanged(object sender, EventArgs e)
        {
