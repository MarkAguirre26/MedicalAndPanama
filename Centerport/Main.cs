...
namespace MedicalManagementSoftware
{
    ...
    public partial class Main : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Database.connectionString = Properties.Settings.Default.MyConString;
            Console.WriteLine(Database.connectionString);
        }
        public void setRestriction()
        {
            //toolStripVisit.Visible = false;
            //toolStripPatient.Visible = false;
            toolStripLaboratory.Visible = false;
            toolStripLandBase.Visible = false;
            toolStripSeaBase.Visible = false;
            toolStripMLC.Visible = false;
            toolStripUltrasound.Visible = false;
            toolStripXRay.Visible = false;
            ...
            MenuItemseaferers.Visible = false;
            MenuItemseaferersMLC.Visible = false;
            MenuItemultrasound.Visible = false;
            MenuItemxRay.Visible = false;
            MenuItemHiv.Visible = false;
            MenuItempsychology.Visible = false;
            stripButton_Immunology.Visible = false;
            ...
            switch (UserLevel)
            {
                ...
                case 2: //Releasing
                    ...
                    break;
                case 3: //Lab
                    stripButton_Immunology.Visible = true;
                    toolStripLaboratory.Visible = true;
                    MenuItemlaboratory.Visible = true;
                    toolStripHIV.Visible = true;
                    MenuItemHiv.Visible = true;
                    break;
                case 4: //Information
                    break;
                case 5: //Psychology
                    toolStripPsychology.Visible = true;
                    MenuItempsychology.Visible = true;
                    break;
                case 6: //Xray
                    toolStripXRay.Visible = true;
                    toolStripHIV.Visible = true;
                    toolStripUltrasound.Visible = true;

                    MenuItemxRay.Visible = true;
                    MenuItemHiv.Visible = true;
                    MenuItemultrasound.Visible = true;
                    break;
        ...
        void ShowLaboratory()
        {
            if ((Application.OpenForms["frm_lab"] as frm_lab) == null)
            {
                Cursor.Current = Cursors.WaitCursor;
                laboratory = false;
                Cursor.Current = Cursors.WaitCursor;
        ...
        void showImmunology()
        {
            if ((Application.OpenForms["Frm_Immunology"] as Frm_Immunology) == null)
            {
                Cursor.Current = Cursors.WaitCursor;
                immunology = false;
                Cursor.Current = Cursors.WaitCursor;
                Frm_Immunology frm = new Frm_Immunology(this);
                frm.MdiParent = this;
                frm.Show();
            }
            else
        ...
        void ShowLandBase()
        {
            if ((Application.OpenForms["frm_Landbase"] as frm_Landbase) == null)
            {
                Cursor.Current = Cursors.WaitCursor;
                landbase = false;
        ...
        void showSeabase()
        {
            if ((Application.OpenForms["frm_seafarer_MEC"] as frm_seafarer_MEC) == null)
            {
                // bseaferer = false;
                //   Strip_sub.Visible = true;
                Cursor.Current = Cursors.WaitCursor;
        ...
        void showUltrasound()
        {
            if ((Application.OpenForms["frm_Ultrasound"] as frm_Ultrasound) == null)
            {
                //Ultrasount = false;
                Cursor.Current = Cursors.WaitCursor;
                // Strip_sub.Visible = true;
        ...
        void showHIV()
        {
            if ((Application.OpenForms["frm_HIV"] as frm_HIV) == null)
            {
                Cursor.Current = Cursors.WaitCursor;
                //HIV = false;
                //  Strip_sub.Visible = true;
        ...
        public void add_mlc()
        {
            ...
            frm_search_Patient_Queuing queue = new frm_search_Patient_Queuing(this);
            queue.queueSearchList_Model = (Application.OpenForms["frm_Seafarer_MLC"] as frm_Seafarer_MLC).SeabaseAdd_model;
            queue.Sea_mlc = true;
            queue.Landbase = false;
            queue.lab = false;
            queue.queue = false;
        ...
        private void ts_add_tumor_Click(object sender, EventArgs e)
        {
            ...
            //    frm_search_Patient_Queuing queue = new frm_search_Patient_Queuing(this);
            //    queue.queueSearchList_Model = (Application.OpenForms["frm_Tumor_Immunological"] as frm_Tumor_Immunological).LabExtraSearchRecord_Add;
            //    queue.immunology = true;
            //    queue.lab = false;
            //    queue.Landbase = false;
            //    queue.queue = false;
            //    queue.seafarer = false;
        ...
        {
            if (this.ActiveMdiChild is Frm_Immunology)
            {
                Cursor.Current = Cursors.WaitCursor;
                ((MyInter)this.ActiveMdiChild).Edit();
        ...
        {
            (Application.OpenForms["Frm_Immunology"] as Frm_Immunology).Close();
        }
     ...
     string mimeType, bool willSeek)
        ...
        private void serverSettingToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void toolStripButton1_Click_1(object sender, EventArgs e)
        {
            if (this.ActiveMdiChild is Frm_Immunology)
            {
                ...
                //add_xray();
                //add_hiv function for immu here
            }
        }
        ...
        private void toolStripPanama_Click(object sender, EventArgs e)
        {
