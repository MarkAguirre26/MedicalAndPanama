    ...
    public partial class frm_user : Form
    {
        ...
        void loaduser()
        {
            if (fmain.UserLevel == 1 || fmain.UserLevel == 2)
            {
                ...
                foreach (var i in list)
                {
                    ...
                    dataGridView1.Rows.Add(i.cn, i.Fullname, i.Username,  i.Description);
                }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
           ...
           // txt_password.Text = EncodeString.Decrypt(dataGridView1.SelectedRows[0].Cells[3].Value.ToString());
            cbo_level.Text = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();      
        ...
        private void cmd_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    db.USER_INSERT(txt_name.Text, txt_username.Text, txt_password.Text, Levelcn);
                  //  db.ExecuteCommand("INSERT INTO tbl_user (Fullname, Username, Password, UserLevel, Remark) VALUES ({0},{1},{2}, {3}, {4})", txt_name.Text, txt_username.Text, txt_password.Text, Levelcn, "1");
                ...
                {
                    db.USER_UPDATE(Convert.ToInt32(dataGridView1.SelectedRows[0].Cells[0].Value.ToString()), txt_name.Text, txt_username.Text, txt_password.Text, Levelcn, "1");
                    //db.ExecuteCommand("UPDATE tbl_user SET Fullname={0}, Username={1}, Password={2}, UserLevel={3} WHERE (cn={4})", txt_name.Text, txt_username.Text, txt_password.Text, Levelcn, dataGridView1.SelectedRows[0].Cells[0].Value.ToString());
