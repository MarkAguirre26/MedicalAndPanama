...
namespace MedicalManagementSoftware.Report
{
    public partial class Report_Landbase : Form
    {
        ...
        public void load_MER2()
        {
            ...
            LandBase_mer2.SetParameterValue("BloodType", bloodType == null ? "" : bloodType);            
        ...
        public void Load_MER()
        {
            ...
            R_Landbase_MER.SetParameterValue("Age", DateClass.getAge(d));
        ...
        public void Load_MLC()
        {
            ...
            R_landbase_MLC.SetParameterValue("Age", DateClass.getAge(d));
        ...
        public void load_Detailed()
        {
            ...
            R_Landbase_detailed.SetParameterValue("Age", DateClass.getAge(d));
            R_Landbase_detailed.SetParameterValue("BloodType",bloodType == null? "": bloodType);
        ...
        public void Load_Summary()
        {
            ...
            R_lanabase_summary.SetParameterValue("Age", DateClass.getAge(d));
