...
namespace MedicalManagementSoftware.Panama
{
    public class Page2Model
    {
        ...
        public string SeaDuty { get; set; }
        public string Revoke { get; set; }
        public string ConsiderDisease { get; set; }
        public string FitToPerformDuries { get; set; }
        ...
        public string AlternativeSuplimentComment2 { get; set; }
